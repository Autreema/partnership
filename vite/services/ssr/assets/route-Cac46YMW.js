...
import { t as Route } from "./route-DSA2P_Y1.js";
...
import { BarChart3, Bell, Check, ChevronDown, ChevronRight, Circle, CreditCard, LayoutDashboard, Link2, LogOut, Package, PanelLeft, Receipt, Settings, ShoppingCart, Sparkles, TrendingUp, User, Users, Wallet, X } from "lucide-react";
...
function AppShell() {
	...
	return /* @__PURE__ */ jsx(SidebarProvider, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AppSidebar, { role }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("header", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("nav", {
						...
						children: crumbs.map((c, i) => /* @__PURE__ */ jsxs("span", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									...
									children: [/* @__PURE__ */ jsx(Bell, { className: "w-4 h-4" }), (notifCount ?? 0) > 0 && /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
								...
								children: [
									...
									/* @__PURE__ */ jsx(DropdownMenuItem, {
										...
										children: /* @__PURE__ */ jsxs(Link, {
											to: "/dashboard/notifications",
											children: [/* @__PURE__ */ jsx(Bell, { className: "w-4 h-4" }), " Notifications"]
										})
									}),
									/* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
...
function AppSidebar({ role }) {
	...
	return /* @__PURE__ */ jsx(Sidebar, {
		...
		children: /* @__PURE__ */ jsxs(SidebarContent, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
			...
			}), /* @__PURE__ */ jsxs(SidebarGroup, { children: [!collapsed && /* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Navigation" }), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: nav.map((n) => {
				return /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
					...
					children: /* @__PURE__ */ jsxs(Link, {
						to: n.to,
						children: [/* @__PURE__ */ jsx(n.icon, { className: "w-4 h-4" }), !collapsed && /* @__PURE__ */ jsx("span", { children: n.label })]
					})
				}) }, n.to);
			}) }) })] })]
		})
